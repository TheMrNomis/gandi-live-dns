...
def get_dnsip(uuid):
    ...
    url = config.api_endpoint+ '/zones/' + uuid + '/records/' + config.subdomains[0] + '/' + config.record_type
...
def update_records(uuid, dynIP, subdomain):
    ...
    '''
    url = config.api_endpoint+ '/zones/' + uuid + '/records/' + subdomain + '/' + config.record_type
